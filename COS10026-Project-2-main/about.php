        ...
        <div class="about-container">
            ...
            <div class="team-container">
                ...
                <div class="team-member">
                    ...
                    <p class="title"><strong>Back-end: </strong>Allowing jobs.php file to retrieve job data and displaying them to web browsers; fixing password_hash undefined call due to cases where php version is less than 5.5  </p>     
                  </div>
            </div>
        </div>
    </section>
